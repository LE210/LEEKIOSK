...
<body style="display: flex; font-family: 'yg-jalnan';">
	...
	<div id="orderMenu"
		...
		<div class="menu" style="display: flex; flex:0 0 30%">
			<div style="flex: 3 0 0; text-align: center;">${dto.p_name}</div>
			<div style="flex: 1 0 0; text-align: center;">${dto.o_quantity}</div>
			<div style="flex: 2 0 0; text-align: right;">${dto.p_price}</div>
		</div>
		<div class="option" style="display: flex; flex:0 0 30%">
			...
			<div style="flex: 2 0 0; text-align: right;">${dto.o_shot}원</div>
		</div>
		<div class="option" style="display: flex; flex:0 0 30%">
			...
			<div style="flex: 2 0 0; text-align: right;">${dto.o_size}원</div>
		</div>
		</c:forEach>
	</div>
