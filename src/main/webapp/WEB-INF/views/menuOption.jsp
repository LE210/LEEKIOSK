			...
			<div
				...
				<div style="display: flex; flex-direction: column; flex: 1 0 0;">
					...
					<div
						...
						<div style="display: flex; flex: 1 0 0; justify-content: center; zoom: 1.5;">
			...
			<div
				...
				<div style="display: table; flex: 1.4 0 0;">
					<div id="p_price"
						...
						<input type="hidden" name="p_price" value="${menu.p_price}"/>
						<input type="hidden" name="o_pickup" value="${o_pickup}" />
						<<input type="hidden" name="o_num" value="${sessionScope.orderNum}" />
					<hr>
				</div>
				<div style="display: flex; flex-direction: column; flex: 1 0 0;">
