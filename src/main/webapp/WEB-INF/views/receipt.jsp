...
<c:forEach var="cartItem" items="${cartItems}">
	...
	<div id="where"
		...
		<div
			id="image1" name="hi"
			style="flex: 0 0 20%; background-size: 100% 100%; background-repeat: no-repeat; background-image: url('/kiosk/resources/images/breakfast-tray.png'); background-size: contain"></div>
	</div>
	...
	<div id="orderMenu"
		...
		<div class="menu" style="display: flex; flex:0 0 30%">
			<div style="flex: 3 0 0; text-align: center;">${cartItem.p_name}</div>
			<div style="flex: 1 0 0; text-align: center;">${cartItem.o_quantity}</div>
			<div style="flex: 2 0 0; text-align: right;">${cartItem.p_price}</div>
		</div>
		<div class="option" style="display: flex; flex:0 0 30%">
			...
			<div style="flex: 2 0 0; text-align: right;">${cartItem.o_shot}원</div>
		</div>
		<div class="option" style="display: flex; flex:0 0 30%">
			...
			<div style="flex: 2 0 0; text-align: right;">${cartItem.o_size}원</div>
		</div>
