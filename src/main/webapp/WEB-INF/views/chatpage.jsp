...
<!-- 						<th style="width: 9%;">고객번호</th> -->
						...
						<th style="width: 9%;">샷추가</th>
 						<th style="width: 9%;">휘핑</th> 
				...
				<tbody>
					<c:forEach var="cart" items="${cartList}">
						<c:forEach var="dto" items="${cart}">
							<tr>
								<td class="text-center">${dto.o_num}</td>
								<td class="text-center">${dto.o_pickup}</td>
								<td class="text-center">${dto.p_name}</td>
								<td class="text-center">${dto.o_size}</td>
								<td class="text-center">${dto.o_shot}</td>					
								<td class="text-center">${dto.o_whipping}</td>
								<td class="text-center">${dto.o_quantity}</td>
