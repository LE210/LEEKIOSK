		...
		<div id="menucate"
			...
			<div class="menu" id="cate"
				...
				<div name="categoryId" value="0"
					style="margin: 5px; background-color: #ffffff; flex: 0 0 30%; display: flex; align-items: center; justify-content: center; border-radius: 12%;">ICE</div>
				...
				<div name="categoryId" value="2"
					style="margin: 5px; background-color: #ffffff; flex: 0 0 30%; display: flex; align-items: center; justify-content: center; border-radius: 12%;">ADE</div>
				<div name="categoryId" value="3"
					style="margin: 5px; background-color: #ffffff; flex: 0 0 30%; display: flex; align-items: center; justify-content: center; border-radius: 12%;">DESSERT</div>
				<div name="categoryId" value="4"
					style="margin: 5px; background-color: #ffffff; flex: 0 0 30%; display: flex; align-items: center; justify-content: center; border-radius: 12%;">TEA</div>
			...
			<div class="menu" id="menu"
				style="align-content: flex-start; justify-content: flex-start; font-size: 1.5rem; overflow-y: scroll; display: flex; flex-wrap: wrap; background-color: #111111; flex: 0.9 0 0">
		...
		<div id="cart" style="font-size: 1.2rem; display: flex; flex: 0.8 0 0">
				...
				<c:forEach var="cartItem" items="${cartItems}" varStatus="status">
					<div
						...
						<div style="background-color: #BBBBBB; flex: 0.7 0 0; padding: 5%">
							<div
								style="display: flex; flex-direction: row-reverse; border-radius: 20%; background-image: url('/kiosk/resources/images/menu_pic/${cartItem.p_image}'); background-repeat: no-repeat; background-size: contain; width: 100%; height: 100%;">
						...
						<div
							style="flex: 0.3 0 0; background-color: #FFFFFF; display: flex; align-items: center; justify-content: center">${cartItem.p_name}</div>
					</div>
				</c:forEach>
			</div>
			...
			<div
				...
				<div style="display: flex; flex: 2 0 0;">
					...
					<button id="payBtn"class="btn" style="margin: 3%; flex: 1 0 0;">결제</button>
				</div>
			</div>
		</div>
	</div>
