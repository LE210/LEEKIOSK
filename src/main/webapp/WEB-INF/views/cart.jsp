			...
			<div class="CartList" id="cart"
				...
				<div
					...
					<div style="background-color: #BBBBBB; flex: 0.7 0 0; padding: 5%">
						<div id="menu-in"
							style="display: flex; flex-direction: row-reverse; border-radius: 20%; background-image: url('resources/images/menu_pic/${kioMenu.p_image}'); background-repeat: no-repeat; background-size: contain; width: 100%; height: 100%;">
...
<%-- 					<input type="checkbox" name="chkbox" value="${cartDto.p_price}" checked="checked"></div>	 --%>
					...
					<input type="hidden" value="${o_pickup}">				
					</form>
