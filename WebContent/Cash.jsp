...
<body
	...
	<button style="border:0px!important; background-color:#000000!important; margin: 2%; display:flex; width:8%; height:30%";><img alt="" src="./images/back.png" style="flex:1 0 0" onclick="history.back()"></button>
	</div>
	<div id="cash"
		...
		<div
			style="flex: 4 0 0; background-image: url('./images/card.png'); background-size: 100% 100%"></div>
		<div
...
<script>
$("#modal-content").load("receipt.jsp");
