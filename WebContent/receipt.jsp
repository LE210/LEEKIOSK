...
<body style="display: flex; font-family: 'yg-jalnan';">
	...
	<div id="orderMenu"
		...
		<div class="menu" style="display: flex; flex:0 0 30%">
			<div style="flex: 3 0 0; text-align: center;">아메리카노</div>
			<div style="flex: 1 0 0; text-align: center;">x1</div>
			<div style="flex: 2 0 0; text-align: right;">1500원</div>
		</div>
		<div class="option" style="display: flex; flex:0 0 30%">
			...
			<div style="flex: 1 0 0; text-align: center;">x1</div>
			<div style="flex: 2 0 0; text-align: right;">500원</div>
		</div>
		<div class="option" style="display: flex; flex:0 0 30%">
